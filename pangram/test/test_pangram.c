...
static void
test_perfect_lowercase_pangram (void)
{
    // TEST_IGNORE();
...
static void
test_pangram_with_underscores (void)
{
    // TEST_IGNORE();
...
static void
test_pangram_with_numbers (void)
{
    // TEST_IGNORE();
    const char sentence[] =
...
static void
test_missing_letters_replaced_by_numbers (void)
{
    // TEST_IGNORE();
...
static void
test_mixed_case_and_punctuation (void)
{
    // TEST_IGNORE();
...
static void
test_upper_and_lower_case_of_same_character (void)
{
    // TEST_IGNORE();
